...
def usage_demo():
    ...
    sns_wrapper = SnsWrapper(boto3.resource('sns', region_name='us-east-1', aws_access_key_id=os.environ['AWS_ACCESS_KEY_ID'], aws_secret_access_key=os.environ['AWS_ACCESS_KEY']))

    # Create a topic.
    topic = sns_wrapper.create_topic('my-topic')
    print()
